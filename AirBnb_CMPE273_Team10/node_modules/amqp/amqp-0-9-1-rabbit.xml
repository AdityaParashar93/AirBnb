...
<!-- WARNING: Modified from the official 0-9-1 specification XML by the addition 
	of: confirm.select and confirm.select-ok, exchange.bind and exchange.bind-ok, 
	exchange.unbind and exchange.unbind-ok, basic.nack, the ability for the Server 
	to send basic.ack, basic.nack and basic.cancel to the client, and the un-deprecation 
	of exchange.declare{auto-delete} and exchange.declare{internal} -->

<!-- Copyright Notice ================ Copyright (c) 2006-2008 Cisco Systems, 
	Credit Suisse, Deutsche Boerse Systems, Envoy Technologies, Inc., Goldman 
	Sachs, IONA Technologies PLC, iMatix Corporation, JPMorgan Chase Bank Inc. 
	N.A, Novell, Rabbit Technologies Ltd., Red Hat, Inc., TWIST Process Innovations 
	Ltd, WS02 Inc. and 29West Inc. All rights reserved. License ======= Cisco 
	Systems, Credit Suisse, Deutsche Boerse Systems, Envoy Technologies, Inc., 
	Goldman Sachs, IONA Technologies PLC, iMatix Corporation, JPMorgan Chase 
	Bank Inc. N.A, Novell, Rabbit Technologies Ltd., Red Hat, Inc., TWIST Process 
	Innovations Ltd, WS02, Inc. and 29West Inc. (collectively, the "Authors") 
	each hereby grants to you a worldwide, perpetual, royalty-free, nontransferable, 
	nonexclusive license to (i) copy, display, distribute and implement the Advanced 
	Messaging Queue Protocol ("AMQP") Specification and (ii) the Licensed Claims 
	that are held by the Authors, all for the purpose of implementing the Advanced 
	Messaging Queue Protocol Specification. Your license and any rights under 
	this Agreement will terminate immediately without notice from any Author 
	if you bring any claim, suit, demand, or action related to the Advanced Messaging 
	Queue Protocol Specification against any Author. Upon termination, you shall 
	destroy all copies of the Advanced Messaging Queue Protocol Specification 
	in your possession or control. As used hereunder, "Licensed Claims" means 
	those claims of a patent or patent application, throughout the world, excluding 
	design patents and design registrations, owned or controlled, or that can 
	be sublicensed without fee and in compliance with the requirements of this 
	Agreement, by an Author or its affiliates now or at any future time and which 
	would necessarily be infringed by implementation of the Advanced Messaging 
	Queue Protocol Specification. A claim is necessarily infringed hereunder 
	only when it is not possible to avoid infringing it because there is no plausible 
	non-infringing alternative for implementing the required portions of the 
	Advanced Messaging Queue Protocol Specification. Notwithstanding the foregoing, 
	Licensed Claims shall not include any claims other than as set forth above 
	even if contained in the same patent as Licensed Claims; or that read solely 
	on any implementations of any portion of the Advanced Messaging Queue Protocol 
	Specification that are not required by the Advanced Messaging Queue ProtocolSpecification, 
	or that, if licensed, would require a payment of royalties by the licensor 
	to unaffiliated third parties. Moreover, Licensed Claims shall not include 
	(i) any enabling technologies that may be necessary to make or use any Licensed 
	Product but are not themselves expressly set forth in the Advanced Messaging 
	Queue Protocol Specification (e.g., semiconductor manufacturing technology, 
	compiler technology, object oriented technology, networking technology, operating 
	system technology, and the like); or (ii) the implementation of other published 
	standards developed elsewhere and merely referred to in the body of the Advanced 
	Messaging Queue Protocol Specification, or (iii) any Licensed Product and 
	any combinations thereof the purpose or function of which is not required 
	for compliance with the Advanced Messaging Queue Protocol Specification. 
	For purposes of this definition, the Advanced Messaging Queue Protocol Specification 
	shall be deemed to include both architectural and interconnection requirements 
	essential for interoperability and may also include supporting source code 
	artifacts where such architectural, interconnection requirements and source 
	code artifacts are expressly identified as being required or documentation 
	...
	of products (hardware, software or combinations thereof) that implement and 
	are compliant with all relevant portions of the Advanced Messaging Queue 
	Protocol Specification. The following disclaimers, which you hereby also 
	acknowledge as to any use you may make of the Advanced Messaging Queue Protocol 
	Specification: THE ADVANCED MESSAGING QUEUE PROTOCOL SPECIFICATION IS PROVIDED 
	...
	THE ADVANCED MESSAGING QUEUE PROTOCOL SPECIFICATION ARE SUITABLE FOR ANY 
	PURPOSE; NOR THAT THE IMPLEMENTATION OF THE ADVANCED MESSAGING QUEUE PROTOCOL 
	SPECIFICATION WILL NOT INFRINGE ANY THIRD PARTY PATENTS, COPYRIGHTS, TRADEMARKS 
	OR OTHER RIGHTS. THE AUTHORS WILL NOT BE LIABLE FOR ANY DIRECT, INDIRECT, 
	SPECIAL, INCIDENTAL OR CONSEQUENTIAL DAMAGES ARISING OUT OF OR RELATING TO 
	ANY USE, IMPLEMENTATION OR DISTRIBUTION OF THE ADVANCED MESSAGING QUEUE PROTOCOL 
	SPECIFICATION. The name and trademarks of the Authors may NOT be used in 
	any manner, including advertising or publicity pertaining to the Advanced 
	Messaging Queue Protocol Specification or its contents without specific, 
	written prior permission. Title to copyright in the Advanced Messaging Queue 
	Protocol Specification will at all times remain with the Authors. No other 
	rights are granted by implication, estoppel or otherwise. Upon termination 
	of your license or rights under this Agreement, you shall destroy all copies 
	of the Advanced Messaging Queue Protocol Specification in your possession 
	or control. Trademarks ========== JPMorgan, JPMorgan Chase, Chase, the JPMorgan 
	Chase logo and the Octagon Symbol are trademarks of JPMorgan Chase & Co. 
	IMATIX and the iMatix logo are trademarks of iMatix Corporation sprl. IONA, 
	IONA Technologies, and the IONA logos are trademarks of IONA Technologies 
	PLC and/or its subsidiaries. LINUX is a trademark of Linus Torvalds. RED 
	HAT and JBOSS are registered trademarks of Red Hat, Inc. in the US and other 
	countries. Java, all Java-based trademarks and OpenOffice.org are trademarks 
	of Sun Microsystems, Inc. in the United States, other countries, or both. 
	Other company, product, or service names may be trademarks or service marks 
	of others. Links to full AMQP specification: ================================= 
	http://www.amqp.org -->

<!-- <!DOCTYPE amqp SYSTEM "amqp.dtd"> -->

<!-- XML Notes We use entities to indicate repetition; attributes to indicate 
	properties. We use the 'name' attribute as an identifier, usually within 
	the context of the surrounding entities. We use spaces to seperate words 
	in names, so that we can print names in their natural form depending on the 
	context - underlines for source code, hyphens for written text, etc. We do 
	not enforce any particular validation mechanism but we support all mechanisms. 
	The protocol definition conforms to a formal grammar that is published seperately 
...
<amqp major="0" minor="9" revision="1" port="5672"
	...
	<domain name="no-wait" type="bit" label="do not send reply method">
		<doc>
			...
			not wait
			for a reply method. If the server could not complete the method it will
			raise a
	...
	<domain name="queue-name" type="shortstr" label="queue name">
		<doc>
			The queue name identifies the queue within the vhost. In methods where
			the queue
			name may be blank, and that has no specific significance, this refers to
			the
			'current' queue for the channel, meaning the last queue that the client
			declared
			on the channel. If the client did not declare a queue, and the method
			needs a
	...
	<domain name="redelivered" type="bit" label="message is being redelivered">
		...
		<rule name="implementation">
			<doc>
				...
				redelivering a message that was not successfully acknowledged, the
				server
		...
		<rule name="hinting">
			<doc>
				The client MUST NOT rely on the redelivered field but should take it as
				a
	...
	<class name="connection" handler="connection" index="10"
		...
		<method name="start" synchronous="1" index="10"
			...
			<doc>
				...
				client the
				protocol version that the server proposes, along with a list of security
				mechanisms
			...
			<rule name="protocol-name">
				<doc>
					...
					header,
					it MUST respond with a valid protocol header and then close the
					socket
					connection.
				</doc>
				<doc type="scenario">
					The client sends a protocol header containing an invalid protocol
					name.
					The server MUST respond by sending a valid protocol header and then
					closing
					the connection.
				</doc>
			</rule>
			<rule name="server-support">
				...
				<doc type="scenario">
					...
					implementation, e.g. 2.0. The server must respond with a protocol
					header
			...
			<field name="server-properties" domain="peer-properties" label="server properties">
				<rule name="required-fields">
					<doc>
						The properties SHOULD contain at least these fields: "host",
						specifying the
						server host name or address, "product", giving the name of the server
						product,
						"version", giving the name of the server version, "platform", giving the
						name
						of the operating system, "copyright", if appropriate, and
						"information", giving
						other general information.
					</doc>
					<doc type="scenario">
						Client connects to server and inspects the server properties. It checks
						for
		...
		<method name="start-ok" synchronous="1" index="11"
			...
			<field name="client-properties" domain="peer-properties" label="client properties">
				<rule name="required-fields">
					...
					<doc>
						The properties SHOULD contain at least these fields: "product",
						giving the name
						of the client product, "version", giving the name of the client
						version, "platform",
						giving the name of the operating system, "copyright", if appropriate,
						and
			...
			<field name="mechanism" domain="shortstr" label="selected security mechanism">
				...
				<rule name="validity">
					<doc>
						If the mechanism field does not contain one of the security
						mechanisms
					...
					<doc type="scenario">
						...
						server must respond by closing the connection (a socket close,
						with no
			...
			<field name="locale" domain="shortstr" label="selected message locale">
				<doc>
					A single message locale selected by the client, which must be one of
					those
					specified by the server.
				</doc>
				<assert check="notnull" />
		...
		<method name="secure" synchronous="1" index="20"
			...
			<doc>
				...
				both peers have
				received sufficient information to authenticate each other. This method
				challenges
		...
		<method name="tune" synchronous="1" index="30"
			...
			<field name="frame-max" domain="long" label="proposed maximum frame size">
				<doc>
					...
					including
					frame header and end-byte. The client can negotiate a lower value. Zero
					means
					that the server does not impose any specific limit but may reject very
					large
					frames if it cannot allocate resources for them.
				</doc>
				<rule name="minimum">
					<doc>
						Until the frame-max has been negotiated, both peers MUST accept frames
						of up
					...
					<doc type="scenario">
						Client connects to server and sends a large properties field, creating a
						frame
		...
		<method name="tune-ok" synchronous="1" index="31"
			...
			<field name="channel-max" domain="short" label="negotiated maximum channels">
				...
				<rule name="upper-limit">
					<doc>
						If the client specifies a channel max that is higher than the value
						provided
						by the server, the server MUST close the connection without
						attempting a
			...
			<field name="frame-max" domain="long" label="negotiated maximum frame size">
				<doc>
					...
					connection.
					Zero means that the client does not impose any specific limit but may
					reject
					very large frames if it cannot allocate resources for them. Note that
					the
				...
				<rule name="upper-limit">
					<doc>
						If the client specifies a frame max that is higher than the value
						provided
						by the server, the server MUST close the connection without
						attempting a
						negotiated close. The server may report the error in some fashion to assist
		...
		<method name="open" synchronous="1" index="40"
			...
			<doc>
				...
				number
				of each type of entity that may be used, per connection and/or in
				total.
			</doc>
			...
			<field name="virtual-host" domain="path" label="virtual host name">
				...
				<rule name="separation">
					<doc>
						...
						host. An application, connected to a specific virtual host, MUST
						NOT be able
		...
		<method name="close" synchronous="1" index="50"
			...
			<doc>
				...
				This may be
				due to internal conditions (e.g. a forced shut-down) or due to an error
				handling
				a specific method, i.e. an exception. When a close is due to an
				exception, the
				sender provides the class and method id of the method which caused the
				exception.
			</doc>
			<rule name="stability">
				<doc>
					...
					Close-OK MUST
					be discarded. The response to receiving a Close after sending Close
					must be to
					send Close-Ok.
				</doc>
			</rule>
	...
	<class name="channel" handler="channel" index="20"
		...
		<method name="flow" synchronous="1" index="20"
			...
			<doc>
				...
				sent by
				a consumer. This is a simple flow-control mechanism that a peer can
				use to avoid
			...
			<rule name="bidirectional">
				<doc>
					When sending content frames, a peer SHOULD monitor the channel for
					incoming
			...
			<rule name="throttling">
				<doc>
					...
					data for
					internal reasons, for example, when exchanging data over a slower
					connection.
				</doc>
			</rule>
			...
			<rule name="expected-behaviour">
				<doc>
					The peer that requests a Channel.Flow method MAY disconnect and/or ban
					a peer
					that does not respect the request. This is to prevent badly-behaved
					clients
			...
			<field name="active" domain="bit" label="start/stop content frames">
				<doc>
					If 1, the peer starts sending content frames. If 0, the peer stops
					sending
					content frames.
				</doc>
			</field>
		...
		<method name="flow-ok" index="21" label="confirm a flow method">
			...
			<field name="active" domain="bit" label="current flow setting">
				<doc>
					Confirms the setting of the processed flow method: 1 means the peer will
					start
		...
		<method name="close" synchronous="1" index="40"
			...
			<doc>
				...
				may be due to
				internal conditions (e.g. a forced shut-down) or due to an error handling a
				specific
				method, i.e. an exception. When a close is due to an exception, the sender
				provides
	...
	<class name="exchange" handler="channel" index="40"
		...
		<rule name="recommended-types">
			<doc>
				The server SHOULD implement these standard exchange types: topic,
				headers.
			</doc>
			<doc type="scenario">
				Client attempts to declare an exchange with each of these standard types.
		...
		<rule name="required-instances">
			<doc>
				...
				for each standard exchange type that it implements, where the name
				of the
			...
			<doc>
				...
				exchange instances: one named "amq.direct", the other with no public
				name
		...
		<rule name="default-exchange">
			<doc>
				The server MUST pre-declare a direct exchange with no public name to
				act as
				the default exchange for content Publish methods and for default queue
				bindings.
			</doc>
			<doc type="scenario">
		...
		<rule name="default-access">
			<doc>
				...
				by specifying an empty exchange name in the Queue.Bind and content
				Publish
				methods.
			</doc>
		</rule>
		...
		<method name="declare" synchronous="1" index="10"
			...
			<rule name="minimum">
				...
				<doc type="scenario">
					The client declares as many exchanges as it can until the server
					reports
					an error; the number of exchanges successfully declared must be at
					least
					sixteen.
				</doc>
			</rule>
			...
			<field name="exchange" domain="exchange-name">
				<rule name="reserved" on-failure="access-refused">
					<doc>
						...
						standardised exchanges. The client MAY declare an exchange
						starting with
			...
			<field name="type" domain="shortstr" label="exchange type">
				<doc>
					...
					the
					server. The exchange types define the functionality of the exchange - i.e.
					how
				...
				<rule name="typed" on-failure="not-allowed">
					<doc>
						...
						attempt to redeclare an existing exchange with a different type
						than used
		...
		<method name="delete" synchronous="1" index="20"
			...
			<field name="exchange" domain="exchange-name">
				<rule name="exists" on-failure="not-found">
					<doc>
						The client MUST NOT attempt to delete an exchange that does not
						exist.
					</doc>
				</rule>
				<assert check="notnull" />
			...
			<field name="if-unused" domain="bit" label="delete only if unused">
				<doc>
					...
					bindings. If
					the exchange has queue bindings the server does not delete it but
					raises a
					channel exception instead.
				</doc>
				<rule name="in-use" on-failure="precondition-failed">
					<doc>
						The server MUST NOT delete an exchange that has bindings on it, if
						the if-unused
						field is true.
					</doc>
					<doc type="scenario">
						The client declares an exchange, binds a queue to it, then tries to
						delete it
	...
	<class name="queue" handler="channel" index="50" label="work with queues">
		<doc>
			...
			or created at
			runtime. Queues must be attached to at least one exchange in order to receive
			messages
			from publishers.
		</doc>
		...
		<method name="declare" synchronous="1" index="10"
			...
			<rule name="default-binding">
				...
				<doc type="scenario">
					...
					exchange, attempts to send a message through the default exchange
					binding,
					i.e. publish a message to the empty exchange, with the queue name as
					routing
					key.
				</doc>
			</rule>
			...
			<rule name="minimum-queues">
				...
				<doc type="scenario">
					Client attempts to declare as many queues as it can until the server
					reports
			...
			<field name="queue" domain="queue-name">
				<rule name="default-name">
					...
					<doc type="scenario">
						Client attempts to declare several queues with an empty name. The client
						then
			...
			<field name="passive" domain="bit" label="do not create queue">
				...
				<rule name="passive" on-failure="not-found">
					...
					<doc type="scenario">
						...
						the server to respond with a declare-ok. Client then attempts to
						declare
						a non-existent queue with the passive option, and the server must
						close
				...
				<rule name="equivalent">
					<doc>
						...
						requested queue matches these fields, and MUST raise a channel
						exception
						if not.
					</doc>
					<doc type="scenario">
			...
			<field name="durable" domain="bit" label="request a durable queue">
				<doc>
					...
					durable. Durable
					queues remain active when a server restarts. Non-durable queues
					(transient
					queues) are purged if/when a server restarts. Note that durable queues do
					not
				...
				<rule name="persistence">
					...
					<doc type="scenario">
						Client declares a durable queue. The server is then restarted. The
						client
						then attempts to send a message to the queue. The message should be
						successfully
						delivered.
					</doc>
				</rule>
			...
			<field name="exclusive" domain="bit" label="request an exclusive queue">
				<doc>
					...
					deleted when that connection closes. Passive declaration of an
					exclusive
				...
				<rule name="types">
					...
					<doc type="scenario">
						A client declares two named queues, one exclusive and one
						non-exclusive.
					</doc>
				</rule>
				...
				<rule name="exclusive" on-failure="resource-locked">
					...
					<doc type="scenario">
						One client declares an exclusive queue. A second client on a
						different
			...
			<field name="auto-delete" domain="bit"
				...
				<rule name="pre-existence">
					...
					<doc type="scenario">
						Client declares two named queues, one as auto-delete and one
						explicit-delete.
						Client then attempts to declare the two queues using the same names
						again,
						but reversing the value of the auto-delete field in each case. Verify
						that the
		...
		<method name="declare-ok" synchronous="1" index="11"
			...
			<field name="queue" domain="queue-name">
				<doc>
					Reports the name of the queue. If the server generated a queue name, this
					field
					contains that name.
				</doc>
				<assert check="notnull" />
			...
			<field name="consumer-count" domain="long" label="number of consumers">
				<doc>
					Reports the number of active consumers for the queue. Note that consumers
					can
					suspend activity (Channel.Flow) in which case they do not appear in this
					count.
				</doc>
			</field>
		</method>
		...
		<method name="bind" synchronous="1" index="20"
			...
			<doc>
				...
				not
				receive any messages. In a classic messaging model, store-and-forward
				queues
				are bound to a direct exchange and subscription queues are bound to a
				topic
				exchange.
			</doc>
			...
			<rule name="duplicates">
				<doc>
					...
					bind
					methods for a specific queue, with identical arguments - without treating
					these
					as an error.
				</doc>
				<doc type="scenario">
					A client binds a named queue to an exchange. The client then repeats
					the bind
			...
			<rule name="unique">
				<doc>
					A server MUST not deliver the same message more than once to a
					queue, even if
					the queue has multiple bindings that match the message.
				</doc>
				<doc type="scenario">
					A client declares a named queue and binds it using multiple bindings
					to the
			...
			<rule name="transient-exchange">
				...
				<doc type="scenario">
					A client declares a transient exchange. The client then declares a
					named durable
					queue and then attempts to bind the transient exchange to the durable
					queue.
				</doc>
			</rule>
			...
			<rule name="durable-exchange">
				...
				<doc type="scenario">
					A server declares a named durable queue and binds it to a durable
					exchange. The
					server is restarted. The client then attempts to use the queue/exchange
					combination.
				</doc>
			</rule>
			...
			<field name="routing-key" domain="shortstr" label="message routing key">
				<doc>
					...
					queue name
					is empty, the server uses the last queue declared on the channel. If
					the
					routing key is also empty, the server uses this queue name for the routing
					key as well. If the queue name is provided but the routing key is
					empty, the
				...
				<rule name="direct-exchange-key-matching">
					<doc>
						If a message queue binds to a direct exchange using routing key K
						and a
		...
		<method name="purge" synchronous="1" index="30" label="purge a queue">
			...
			<rule name="02">
				<doc>
					The server MUST NOT purge messages that have already been sent to a
					client
			...
			<rule name="03">
				<doc>
					...
					administrators
					to recover accidentally-purged messages. The server SHOULD NOT keep
					purged
					messages in the same storage spaces as the live messages since the volumes
					of
		...
		<method name="delete" synchronous="1" index="40" label="delete a queue">
			<doc>
				...
				messages are sent
				to a dead-letter queue if this is defined in the server configuration,
				and all
			...
			<rule name="01">
				<doc>
					The server SHOULD use a dead-letter queue to hold messages that were
					pending on
			...
			<field name="if-unused" domain="bit" label="delete only if unused">
				<doc>
					...
					If the
					queue has consumers the server does does not delete it but raises a
					channel
					exception instead.
				</doc>
				<rule name="in-use" on-failure="precondition-failed">
					<doc>
						The server MUST NOT delete a queue that has consumers on it, if the
						if-unused
						field is true.
					</doc>
					<doc type="scenario">
						The client declares a queue, and consumes from it, then tries to
						delete it
						setting if-unused to true.
					</doc>
				</rule>
			...
			<field name="if-empty" domain="bit" label="delete only if empty">
				...
				<rule name="not-empty" on-failure="precondition-failed">
					...
					<doc type="scenario">
						The client declares a queue, binds it and publishes some messages
						into it,
	...
	<class name="basic" handler="channel" index="60"
		...
		<rule name="02">
			...
			<doc type="scenario">
				...
				messages do not get lost (presumably the server will write them to
				disk).
			</doc>
		</rule>
		...
		<rule name="03">
			<doc>
				The server MAY use the Channel.Flow method to slow or stop a basic
				message
				publisher when necessary.
			</doc>
			<doc type="scenario">
				Declare a queue overflow situation with non-persistent messages and verify
				whether the server responds with Channel.Flow or not. Repeat with
				persistent
				messages.
			</doc>
		</rule>
		...
		<rule name="05">
			<doc>
				The server MAY discard or dead-letter non-persistent basic messages on
				a
		...
		<rule name="06">
			...
			<doc type="scenario">
				...
				message. Consume messages from the queue and verify that the first
				message
		...
		<rule name="07">
			...
			<doc type="scenario">
				...
				priority values from 0 to 9 are exercised. A good scenario would be
				ten
		...
		<rule name="08">
			...
			<doc type="scenario">
				...
				settings to a queue. Consume and verify that messages arrive in same
				order
		...
		<rule name="10">
			<doc>
				The server MUST support explicitly acknowledged delivery of Basic
				content,
				i.e. consumers with the no-ack field set to FALSE.
			</doc>
			<doc type="scenario">
				Declare a queue and a consumer using explicit acknowledgements. Publish a
				set of messages to the queue. Consume the messages but acknowledge
				only
		...
		<!-- For application use, no formal behaviour but may hold the name of 
			a private response queue, when used in request messages -->
		...
		<method name="qos" synchronous="1" index="10"
			...
			<doc>
				...
				specified for the
				current channel or for all channels on the connection. The particular
				properties and
				semantics of a qos method always depend on the content class semantics.
				Though the
				qos method could in principle apply to both peers, it is currently
				meaningful only
				for the server.
			</doc>
			...
			<field name="prefetch-size" domain="long" label="prefetch window in octets">
				<doc>
					...
					locally,
					rather than needing to be sent down the channel. Prefetching gives a
					performance
					improvement. This field specifies the prefetch window size in octets. The
					server
					will send a message in advance if it is equal to or smaller in size
					than the
					available prefetch size (and also falls into other prefetch limits). May be
					set
				...
				<rule name="01">
					<doc>
						The server MUST ignore this setting when the client is not processing
						any
						messages - i.e. the prefetch size does not limit the transfer of single
						messages to a client, only the sending in advance of more messages
						while
			...
			<field name="prefetch-count" domain="short"
				...
				<doc>
					...
					used
					in combination with the prefetch-size field; a message will only be
					sent in
					advance if both prefetch windows (and those at the channel and connection
					level)
				...
				<rule name="01">
					...
					<doc type="scenario">
						...
						one. Send multiple messages that exceed the prefetch size. Verify
						that
		...
		<method name="qos-ok" synchronous="1" index="11"
			...
			<doc>
				...
				handled by the
				server. The requested QoS applies to all active consumers until a new QoS
				is
				defined.
			</doc>
			<chassis name="client" implement="MUST" />
		...
		<method name="consume" synchronous="1" index="20"
			...
			<doc>
				...
				request for
				messages from a specific queue. Consumers last as long as the channel they
				were
			...
			<rule name="01">
				<doc>
					The server SHOULD support at least 16 consumers per queue, and
					ideally, impose
					no limit except as defined by available resources.
				</doc>
				<doc type="scenario">
					Declare a queue and create consumers on that queue until the server closes
					the
			...
			<field name="consumer-tag" domain="consumer-tag">
				<doc>
					...
					channel, so two clients can use the same consumer tags. If this
					field is
				...
				<rule name="02" on-failure="not-allowed">
					...
					<doc type="scenario">
						...
						in which consumers have also been created (to test that the server
						uses
			...
			<field name="exclusive" domain="bit" label="request exclusive access">
				<doc>
					Request exclusive consumer access, meaning only this consumer can access
					the
					queue.
				</doc>
				...
				<rule name="01" on-failure="access-refused">
					...
					<doc type="scenario">
						Open two connections to a server, and in one connection declare a
						shared
			...
			<field name="arguments" domain="table" label="arguments for declaration">
				<doc>
					A set of arguments for the consume. The syntax and semantics of
					these
					arguments depends on the server implementation.
				</doc>
			</field>
		...
		<method name="publish" content="1" index="40" label="publish a message">
			<doc>
				...
				be routed
				to queues as defined by the exchange configuration and distributed to
				any active
			...
			<field name="immediate" domain="bit" label="request immediate delivery">
				<doc>
					This flag tells the server how to react if the message cannot be routed
					to a
					queue consumer immediately. If this flag is set, the server will return
					an
					undeliverable message with a Return method. If this flag is zero, the server
					will queue the message, but with no guarantee that it will ever be
					consumed.
				</doc>
		...
		<method name="return" content="1" index="50"
			...
			<doc>
				...
				"immediate"
				flag set, or an unroutable message published with the "mandatory" flag
				set. The
				reply code and text provide information about the reason that the message
				was
				undeliverable.
			</doc>
		...
		<method name="deliver" content="1" index="60"
			...
			<doc>
				...
				asynchronous
				message delivery model, the client starts a consumer using the Consume
				method, then
				the server responds with Deliver methods as and when messages arrive
				for that
				consumer.
			</doc>
			...
			<rule name="01">
				<doc>
					...
					delivered to
					clients and when a message is redelivered a certain number of times - e.g.
					5
					times - without being acknowledged, the server SHOULD consider the
					message to be
			...
			<field name="routing-key" domain="shortstr" label="Message routing key">
				<doc>Specifies the routing key name specified when the message was
					published.</doc>
			</field>
		</method>
		...
		<method name="get" synchronous="1" index="70"
			...
			<doc>
				...
				synchronous
				dialogue that is designed for specific types of application where
				synchronous
		...
		<method name="reject" index="90" label="reject an incoming message">
			...
			<rule name="01">
				<doc>
					...
					method while
					sending message content with a Deliver or Get-Ok method. I.e. the server
					should
					read and process incoming methods while sending output frames. To
					cancel a
			...
			<rule name="03">
				<doc>
					The client MUST NOT use this method as a means of selecting messages
					to process.
				</doc>
				<doc type="scenario">
					TODO.
			...
			<field name="requeue" domain="bit" label="requeue the message">
				...
				<rule name="01">
					<doc>
						...
						context of the current channel. The recommended strategy is to
						attempt to
						deliver the message to an alternative consumer, and if that is not
						possible,
						to move the message to a dead-letter queue. The server MAY use more
						sophisticated tracking to hold the message on the queue and
						redeliver it to
		...
		<method name="recover-async" index="100"
			label="redeliver unacknowledged messages" deprecated="1">
			<doc>
			...
			<rule name="01">
				<doc>
					The server MUST set the redelivered flag on all messages that are
					resent.
				</doc>
				<doc type="scenario">
					TODO.
			...
			<field name="requeue" domain="bit" label="requeue the message">
				<doc>
					If this field is zero, the message will be redelivered to the
					original
		...
		<method name="nack" index="120"
			...
			<doc>
				...
				This method is also used by the server to inform publishers on channels
				in
			...
			<rule name="01">
				<doc>
					The server SHOULD be capable of accepting and processing the Nack
					method while
					sending message content with a Deliver or Get-Ok method. I.e. the server
					should
					read and process incoming methods while sending output frames. To
			...
			<rule name="04">
				<doc>
					A client publishing messages to a channel in confirm mode SHOULD be
	...
	<class name="tx" handler="channel" index="90" label="work with transactions">
		...
		<method name="commit" synchronous="1" index="20"
			...
			<doc>
				...
				performed in
				the current transaction. A new transaction starts immediately after a
				commit.
			</doc>
			<chassis name="server" implement="MUST" />
		...
		<method name="rollback" synchronous="1" index="30"
			...
			<doc>
				...
				the current transaction. A new transaction starts immediately after a
				rollback.
				Note that unacked messages will not be automatically redelivered by
				rollback;
			...
			<rule name="transacted" on-failure="precondition-failed">
				<doc>
					The client MUST NOT use the Rollback method on non-transacted
					channels.
				</doc>
				<doc type="scenario">
